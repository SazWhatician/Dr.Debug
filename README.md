...
[![Tests](https://img.shields.io/badge/Tests-152%2F152%20Passing-34d399?style=flat-square)](https://github.com/SazWhatician/DebugCopilot)
...
| **NPM Package Tarball** | [`release/dr-debug-0.1.18.tgz`](release/) | Install in your package: `npm install ./dr-debug-0.1.18.tgz` |
...
Current test status:
- **31 test suites passing (100%)**
- **152 total tests passing (100%)**
