...
import { type BridgeResponse, newRequestId, REQ, RES } from './bridgeProtocol.js'
 ...
 */
export class BridgeLLMClient implements ILLMClient {
  ...
  private call(op: string, payload: any, signal?: AbortSignal): Promise<any> {
