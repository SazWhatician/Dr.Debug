...
export class LiteRTClient implements ILLMClient {
  ...
  public formatPrompt(messages: ChatMessage[], tools?: ToolDefinition[]): string {
    let prompt = ''
  ...
  public parseResponse(text: string): LLMResponse {
  ...
  private fallbackInference(messages: ChatMessage[], tools?: ToolDefinition[]): string {
